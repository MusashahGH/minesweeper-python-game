...
#add Mines
numMine = 0
while numMine < 1 or numMine > 25:
    numMine = int(input("How many mines? (1 to 25): "))
    if numMine < 1 or numMine > 25:
        print("Impossible! Please enter a number between 1 and 25.")
